...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-common-errors/node_modules/common-errors/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-common-errors/node_modules/common-errors/index.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">66.13% <small>(41 / 62)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-common-errors/node_modules/common-errors/</a> &#187; index.js</div>
</div>
<div class="body">
...
module.exports.logError = <span class="fstat-no" title="function not covered" >function(err, cb) {</span>
<span class="cstat-no" title="statement not covered" >  if (!logErrorDeprecationWarning) <span class="cstat-no" title="statement not covered" >console.warn("logError is deprecated.  Use log instead.");</span></span>
<span class="cstat-no" title="statement not covered" >  logErrorDeprecationWarning = true;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (err &amp;&amp; !err.isLogged) {</span>
<span class="cstat-no" title="statement not covered" >    err.isLogged = true;</span>
...
&nbsp;
module.exports.log = <span class="fstat-no" title="function not covered" >function(err, message) {</span>
<span class="cstat-no" title="statement not covered" >  if (typeof err == 'string') {</span>
<span class="cstat-no" title="statement not covered" >    err = new module.exports.Error(err);</span>
  } else {
...
<span class="cstat-no" title="statement not covered" >    err = module.exports.prependCurrentStack(err, 3);</span>
  }
<span class="cstat-no" title="statement not covered" >  if (err) {</span>
<span class="cstat-no" title="statement not covered" >    console.error(err &amp;&amp; err.stack || err);</span>
<span class="cstat-no" title="statement not covered" >    err.isLogged = true;</span>
  }
<span class="cstat-no" title="statement not covered" >  return err;</span>
}
&nbsp;
module.exports.prependCurrentStack = <span class="fstat-no" title="function not covered" >function(err, offset_) {</span>
<span class="cstat-no" title="statement not covered" >  var linesToSkip = (typeof offset_ === 'undefined') ? 2 : offset_;</span>
<span class="cstat-no" title="statement not covered" >  var stackToPrepend = (new Error()).stack.split("\n").slice(linesToSkip);</span>
<span class="cstat-no" title="statement not covered" >  var mainStack = (err.stack || '').split("\n");</span>
<span class="cstat-no" title="statement not covered" >  var errTitle = mainStack.shift();</span>
<span class="cstat-no" title="statement not covered" >  err.stack = [errTitle].concat(stackToPrepend, "====", mainStack).join("\n");</span>
<span class="cstat-no" title="statement not covered" >  return err;</span>
};
&nbsp;</pre></td></tr>
</table></pre>
